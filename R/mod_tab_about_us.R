      ...
      div(HTML("<p>
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>Cite the <b>shinySbm</b> package developpers team: <br>
                    <i>\"Vanrenterghem T, Aubert J, Chabert-Liddell S (2023). _shinySbm: 'shiny' Application to Use the Stochastic Block Model_., <a href = \"https://CRAN.R-project.org/package=shinySbm\" target = \"_blank\">https://CRAN.R-project.org/package=shinySbm</a>.\"<i></li>
